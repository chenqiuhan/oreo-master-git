    ...
    <div>
        ...
        <div>
            <el-form ref="form" :model="sele">
                <el-form-item>
                <el-input v-model="sele.payAccount" style="width:200px;"  placeholder="请输入付款支付账号" maxlength="50"></el-input>
                <span style="width:50px;" >&nbsp;&nbsp;&nbsp;&nbsp;</span>
                <el-input v-model="sele.receiveAccount" style="width:200px;"  placeholder="请输入收款支付账号" maxlength="50"></el-input>
                <span style="width:50px;" >&nbsp;&nbsp;&nbsp;&nbsp;</span>
        ...
        <el-table
            ...
            <template slot-scope="scope">
                ...
                <router-link :to="{name:'updateThreeFlow',params:{id:scope.row,type:'successThreeFlow'}}">
                    <el-button size="mini" v-if="scope.row.status!=1">修改</el-button>
...
export default {
      ...
      return {
       ...
       var datas=[];
            ...
            this.$axios.post('http://192.168.100.116:8080/project/selectAllThreeFlowByProject',{
                ...
                payAccount:this.sele.payAccount,
                receiveAccount:this.sele.receiveAccount
            })
                .then((response)=>{
    ...
    methods:{
        ...
        handleDelete:function(index,row){
            var confirmMsg;
            if(row.status==1){
                confirmMsg="该条数据已上传成功，已作为可分析数据，此操作将永久删除该条流水信息, 是否继续？";
            }else{
                confirmMsg="此操作将永久删除该条项目流水信息, 是否继续？";
            }
